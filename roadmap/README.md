...
([`LESSON1.md`](../LESSON1.md), [`LESSON2.md`](../LESSON2.md)); Lessons 3-9 are config-driven under
...
Lessons 10-12 finish the **framework tour** - the same agent, rebuilt on somebody else's runtime.

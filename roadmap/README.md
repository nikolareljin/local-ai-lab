...
maps back to the primitives you build in Lessons 1-2 and 3-7 - but they have no runnable code yet.

| # | Outline | Topic |
|---|---------|-------|
| 8 | [LESSON8-langgraph.md](./LESSON8-langgraph.md) | A stateful agent with LangGraph |
...
([`LESSON1.md`](../LESSON1.md), [`LESSON2.md`](../LESSON2.md)); Lessons 3-7 are config-driven under

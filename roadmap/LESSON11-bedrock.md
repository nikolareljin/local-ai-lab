...
| a tool the agent can call | [Lesson 9](../lessons/09-ollama-function-calling/README.md) | Action group + Lambda |
...
[1](../LESSON1.md) and [9](../lessons/09-ollama-function-calling/README.md) give the mental model.

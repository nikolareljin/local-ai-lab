...
> (`./run -l <N> --lang node|csharp`). **Lessons 1-6 ship in all three**; Lesson 7 is Python and Node, because LangChain has no official .NET SDK.
...
| 6 | **Repo-aware AI assistant** | Index a repo into cited passages; answer only from them, refuse when it's not there, and plan-before-edit | [README](./lessons/06-repo-aware-assistant/README.md) | [open](https://nikolareljin.github.io/local-ai-lab/lesson-6-repo-aware-assistant.html) | ✅ Available |
...
| 9 | **Ollama + function calling** | Let a local model pick its own tools, then put guards between its choice and anything that runs; score every local model on the same tasks, plus four applied recipes | [README](./lessons/09-ollama-function-calling/README.md) | [open](https://nikolareljin.github.io/local-ai-lab/lesson-9-ollama-function-calling.html) | ✅ Available |
...
| 3 | Hybrid Retrieval & Reranking | [`lessons/03-hybrid-retrieval-reranking/README.md`](./lessons/03-hybrid-retrieval-reranking/README.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON3.pdf) | ✅ live |
| 4 | RAG Safety & Prompt Injection | [`lessons/04-rag-safety-prompt-injection/README.md`](./lessons/04-rag-safety-prompt-injection/README.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON4.pdf) | ✅ live |
| 5 | RAG Evaluation & Regression Testing | [`lessons/05-rag-evaluation-regression-testing/README.md`](./lessons/05-rag-evaluation-regression-testing/README.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON5.pdf) | ✅ live |
| 6 | Repo-aware AI Assistant | [`lessons/06-repo-aware-assistant/README.md`](./lessons/06-repo-aware-assistant/README.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON6.pdf) | ✅ live |
...
| 9 | Ollama + Function Calling | [`roadmap/LESSON9-ollama.md`](./lessons/09-ollama-function-calling/README.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON9.pdf) | 🚧 roadmap |
...
By the end of the **live lessons (1-7)** you can:
...
- Ground an assistant in **your own codebase** so it cites `path:line` and refuses when the answer
  isn't there.
- Rebuild the whole pipeline on **LangChain** and judge the trade honestly - which components an
  import replaces, which ones you still write yourself, and what the dependency actually costs.

...
guide**, and runs **100% locally**. **Lessons 1-7 are live and runnable**; the rest are on the roadmap.
...
| 8 | A Stateful Agent with LangGraph | [`roadmap/LESSON8-langgraph.md`](./roadmap/LESSON8-langgraph.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON8.pdf) | 🚧 roadmap |
| 9 | Ollama + Function Calling | [`roadmap/LESSON9-ollama.md`](./roadmap/LESSON9-ollama.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON9.pdf) | 🚧 roadmap |

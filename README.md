...
> (`./run -l <N> --lang node|csharp`). **Lessons 1-6 ship in all three.**
...
guide**, and runs **100% locally**. **Lessons 1-6 are live and runnable**; the rest are on the roadmap.
...
| 7 | Rebuild RAG with LangChain | [`roadmap/LESSON7-langchain.md`](./roadmap/LESSON7-langchain.md) | [PDF](https://nikolareljin.github.io/local-ai-lab/pdf/LESSON7.pdf) | 🚧 roadmap |
